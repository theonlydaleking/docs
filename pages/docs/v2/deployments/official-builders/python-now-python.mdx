...
The Web Server Gateway Interface (WSGI) is a calling convention for web servers to forward requests to web applications written in the Python. You can use WSGI with frameworks such as [Flask](/examples/python-flask) or Django.
